...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        cyan: "0 10px 25px -5px rgba(6, 182, 212, 0.1), 0 10px 10px -5px rgba(6, 182, 212, 0.04)",
        emerald: "0 10px 25px -5px rgba(16, 185, 129, 0.1), 0 10px 10px -5px rgba(16, 185, 129, 0.04)",
      },
    },
  },
